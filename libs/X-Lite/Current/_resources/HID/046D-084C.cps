...
<!-- ConferenceCam Connect -->
    ...
    <section name="controlinfo1">
      ...
      <setting name="name" value="answer second call"/>
      <setting name="usagetype" value="OneShot"/>
      <setting name="ignoreCount" value="1"/> <!-- sometimes we get two events in a row -->
    </section>
    <section name="controlinfo2">
      <setting name="id" value="0x00090007"/>
      <setting name="name" value="reject call"/>
      <setting name="usagetype" value="OneShot"/>
    </section>
    ...
    <section name="control1">
      <setting name="action" value="RejectHangup"/>
      <setting name="id" value="0x000B0020"/>
    ...
    <section name="control2">
      <setting name="action" value="Answer"/>
      <setting name="id" value="0x000B0021"/>
      <setting name="name" value="accept second call"/>
      <setting name="state" value="1"/>
    </section>
    ...
    <section name="indicator0">
      ...
      <setting name="controlsToSet" value="0x000B0020"/><!-- used to initialize hook local state to match device -->
    </section>
    <section name="indicator1">
      ...
      <setting name="controlsToClear" value="0x000B0020"/><!-- used to initialize hook local state to match device -->
    </section>
