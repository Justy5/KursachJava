...
<!-- Plantronics BT300 2, Plantronics BT300M 2 (MiniMax dongle, 0x413 and 0x414) -->

    <section name="control0">
      <setting name="action" value="6"/>
      <setting name="id" value="0xFFA000B1"/>
      <setting name="name" value="volume up 2"/>
...
<!-- This device has a sensor to identify whether the device is being worn. It behaves differently 
     depending on this state... -->
<!-- Mode A -->
    <section name="control3">
      <setting name="action" value="5"/>
      <setting name="id" value="0xFFA000B5"/>
      <setting name="name" value="dual volume press / mute toggle"/>
      <setting name="state" value="1"/>
    </section>
...
<!-- Mode B -->
    <section name="control6">
      <setting name="action" value="5"/>
      <setting name="id" value="0xFFA000B9"/>
      <setting name="name" value="dual volume press / mute toggle"/>
      <setting name="state" value="1"/>
    </section>
