...
<!-- Logitech H650e Stereo -->
    ...
    <section name="controlinfo0">
      ...
      <setting name="ignoreCount" value="1"/><!-- ignore the second event when two (down/up or vice-versa) come one after the other -->
    </section>
    ...
    <section name="indicator0">
      ...
      <setting name="toggleValue" value="1"/><!-- sometimes we get no outgoing audio unless we toggle it, even though device doesn't show muted -->
    </section>
    ...
    <section name="indicator6">
      <setting name="action" value="Startup"/>
      <setting name="id" value="0x00080009"/>
      <setting name="name" value="unmute"/>
      <setting name="value" value="0"/>
      <setting name="controlsToSet" value="0x000B0020,0x000B002F"/><!-- used to initialize hook and mute local state to match device "normal" case -->
    </section>
